...
import ListaClanovaZahtevi from "./ListaClanovaZahtevi";


function PlaninarskoDrustvoProfil(props) {
                ...
                <section className="w3l-team" id="team">
                    <div className="team-block py-5">
                        <div className="container py-lg-5">
                            ...
                            <div>
                                <button onClick={() => setModal(true)} className="btn btn-style btn-secondary ttn">Novi dogadjaj</button>
                            </div>
                            ...
                            <div className="title-content text-center mb-lg-3 mb-4">
                                <h3 className="hny-title ttn">Lista zahteva za uclanjivanje</h3>
                            </div>

                            <ListaClanovaZahtevi id={props.id} />
...
export default PlaninarskoDrustvoProfil;